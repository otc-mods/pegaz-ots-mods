-- Elder druid defaults. This is the only file that differs between the shipped presets: it seeds spell words,
...
seed("healing1", { on = false, title = "HP%", text = "exura gran", min = 51, max = 90 })
seed("healing2", { on = false, title = "HP%", text = "exura vita", min = 0, max = 50 })
